...
//        self.monthBackButton.frame = NSMakeRect(0, 0, 38, 39)
    ...
    private func configureViewAppearance() {
        ...
        func configuredButtonWithImage(imageName: String, selector: Selector) -> NSButton {
        ...
        let monthBackwardButton = configuredButtonWithImage(NSImageNameGoLeftTemplate, selector: Selector("monthBackAction:"))
        let monthForwardButton  = configuredButtonWithImage(NSImageNameGoRightTemplate, selector: Selector("monthForwardAction:"))
        

        
        
        self.addSubview(monthBackwardButton)
        self.addSubview(monthForwardButton)
