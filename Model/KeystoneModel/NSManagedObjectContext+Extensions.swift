...
extension NSManagedObjectContext {
    public func setObject(object: NSManagedObject?,
        forSingleObjectCacheKey key: String)
    {
    ...
    public func objectForSingleObjectCacheKey(key: String)
        -> NSManagedObject?
    {
        guard let cache = userInfo[SingleObjectCacheKey]
            as? [String:NSManagedObject]
            else { return nil }
        return cache[key]
    }
}
